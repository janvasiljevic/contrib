...
type Query {
  ...
  groups(
    ...
    """Returns the first _n_ elements from the list. Defaults to 10 if last is not specified. Maximum value: 50."""
    first: Int

    """Returns the elements in the list that come before the specified cursor."""
    before: Cursor

    """Returns the last _n_ elements from the list. Maximum value: 50."""
    last: Int
...
type User implements Node {
  ...
  groups(
    ...
    """Returns the first _n_ elements from the list. Defaults to 25 if last is not specified. Maximum value: 50."""
    first: Int
